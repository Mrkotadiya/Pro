    ...
    return (
        ...
        <div className = 'Cgfilter'>
            ...
            <ul>
                    ...
                    <Link className = 'lined'  to = '?cg=Men'>Burger</Link>
                    <Link className = 'lined'  to = '?cg=Women'>Pizza</Link>
                    <Link className = 'lined'  to = '?cg=Watches'>Meal</Link>
                    <Link className = 'lined' to = '?cg=Shoes'>Coffee</Link>
